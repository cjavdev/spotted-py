...
- <code title="put /playlists/{playlist_id}/images">client.playlists.images.<a href="./src/spotted/resources/playlists/images.py">update</a>(playlist_id, \*\*<a href="src/spotted/types/playlists/image_update_params.py">params</a>) -> None</code>
