...
from spotted.types import ChapterListResponse, ChapterRetrieveResponse
...
class TestChapters:
    ...
    def test_method_list(self, client: Spotted) -> None:
        chapter = client.chapters.list(
            ids="0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29",
        )
        assert_matches_type(ChapterListResponse, chapter, path=["response"])
    ...
    def test_raw_response_list(self, client: Spotted) -> None:
        response = client.chapters.with_raw_response.list(
            ids="0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29",
        )
    ...
    def test_streaming_response_list(self, client: Spotted) -> None:
        with client.chapters.with_streaming_response.list(
            ids="0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncChapters:
    ...
    async def test_method_list(self, async_client: AsyncSpotted) -> None:
        chapter = await async_client.chapters.list(
            ids="0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29",
        )
        assert_matches_type(ChapterListResponse, chapter, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSpotted) -> None:
        response = await async_client.chapters.with_raw_response.list(
            ids="0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSpotted) -> None:
        async with async_client.chapters.with_streaming_response.list(
            ids="0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
