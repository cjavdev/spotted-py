...
from spotted._utils import is_dict
...
logging.getLogger("spotted").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[Spotted]:
...
@pytest.fixture(scope="session")
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncSpotted]:
