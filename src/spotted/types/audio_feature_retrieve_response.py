...
__all__ = ["AudioFeatureRetrieveResponse"]


class AudioFeatureRetrieveResponse(BaseModel):
    ...
    spoken word tracks are clearly "vocal". The closer the instrumentalness value is
    to 1.0, the greater likelihood the track contains no vocal content. Values above
    0.5 are intended to represent instrumental tracks, but confidence is higher as
    ...
    performed live. A value above 0.8 provides strong likelihood that the track is
    live.
    """
    ...
    tracks that are probably made entirely of spoken words. Values between 0.33 and
    0.66 describe tracks that may contain both music and speech, either in sections
    ...
    type: Optional[Literal["audio_features"]] = None
    """The object type."""
